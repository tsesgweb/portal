<section id="panel" class="panel" <?php $full && printf('data-bg-color="%s"', $theme);?>>
  <div class="panel__conteudo_full">
    <div class="panel__conteudo" <?php !$full && printf('data-bg-color="%s"', $theme);?>>
      <div class="panel__linha">
        <div class="panel__content cards card-theme-<?=$theme?>" <?php $type === 'carousel' && print('data-padding="10"');?>>            
          <?php                      
