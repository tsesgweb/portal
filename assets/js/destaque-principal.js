$(window).on('load', function () {
  ...
  Breakpoints.on('sm xs', {
    enter: function () {
      imagemPosition(destaquePrincipal.parent('.destaque__linha').innerHeight())
    },
    leave: function () {
  ...
  $('.fancybox-action').fancybox({
    ...
    buttons: ['close'],
    btnTpl: {
      picture: '<button id="togglePipButton" class="fancybox-button fancybox-button--picture-in-picture" title="Miniplayer">' +
