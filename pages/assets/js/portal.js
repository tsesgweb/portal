...
(function () {
  ...
  //colunas rodape
  jq("<div/>")
    .insertAfter(".mapa-site-conteudo .coluna-mapa:eq(1)")
    .addClass("clearfix visible-sm");
  jq("<div/>")
    .insertAfter(".mapa-site-conteudo .coluna-mapa:eq(2)")
    .addClass("clearfix visible-md");
  jq("<div/>")
    .insertAfter(".mapa-site-conteudo .coluna-mapa:eq(3)")
    .addClass("clearfix visible-lg visible-sm");
  jq("<div/>")
    .insertAfter(".mapa-site-conteudo .coluna-mapa:eq(5)")
    .addClass("clearfix visible-md visible-sm");
  ...
  jq("body").append(
    "<div id='voltar-topo' style='display:none;'><a href='#topo' title='Voltar ao topo da página'><i class='fa fa-chevron-circle-up fa-3' aria-hidden='true'></i></a></div>"
  );
  ...
  (function (jq, document, window, viewport) {
    ...
    if ($htmlLogo !== undefined && $srcLogo !== undefined) {
      var logoToggle = function (status) {
        if (status) {
          $srcLogoResponsive =
            "on" == Cookies.get("contraste")
              ? $srcLogo.replace(".png", "-mobile-inverse.png")
              : $srcLogo.replace(".png", "-mobile.png");
