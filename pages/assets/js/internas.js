$(document).ready(function() {
    $('#breadcrumb').wrapInner('<div class="breadcrumb__linha"/>').wrapInner('<div class="breadcrumb__conteudo"/>');
    //Notícias
    ...
    (function(ajusteTabelasGeral) {
        ajusteTabelasGeral = $("#texto-conteudo table, #texto-conteudo table.listing.grid, #texto-conteudo table.listing, #texto-conteudo table.grid");
    ...
    (function() {
        ...
        $(".compartilhar_whatsapp").attr("href", 'whatsapp://send?text=' + $titulopagina + ' ' + $url + '');
        //Compartilhar facebook
        $(".compartilhar_facebook").click(function(e) {
            window.open('http://www.facebook.com/share.php?u=' + $url + '&t=' + $titulopagina + '', "Compartilhar via facebook", $tamanhoTela);
            e.preventDefault();
            e.stopPropagation();
        });
        //Compartilhar G+
        $(".compartilhar-google-plus").click(function(e) {
            window.open('https://plus.google.com/share?url=' + $url + '', "Compartilhar via g+", $tamanhoTela);
            e.preventDefault();
            e.stopPropagation();
        });
    })();
    ...
    if (typeof jq.fn.datepicker == 'function') {
        ...
        if (typeof jq.fn.mask == 'function') {
            $('.input-daterange input, .data-para-input input').attr('placeholder', 'dd/mm/yyyy');
    ...
    if (typeof jq.fn.popover == 'function') {
        ...
        var $blocoGestor = $("#gestor-responsavel, .noticia-gestor"),
            ...
            $blocoNovo = $('<div/>').addClass('gestor-sem-formatacao').appendTo($blocoGestor).hide();
    ...
    imagem.on('click bind', function() {
        audioTracker = document.getElementById('audio') || document.getElementsByTagName('audio')[0];
...
(function() {
    var offsetNav, menu = $('#nav-principal');
    $('#nav-principal').on('affix-top.bs.affix', function() {
