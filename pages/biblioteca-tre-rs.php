...
<div>
  ...
  <section class="biblioteca" id="banner">
      ...
      <div class="apresentacao">
          ...
          <div class="texto">
              ...
              <p>A Biblioteca Professor Alysson Darowish Mitraud é de acesso público, especializada na área jurídica, com ênfase em Direito Eleitoral e matéria partidária e tem por objetivo oferecer subsídio à tomada de decisões e ao desenvolvimento
                  das atividades administrativas do Tribunal Superior Eleitoral por meio do atendimento das demandas de seus usuários.
      ...
      <div class="colunas">
          ...
          <div class="dois">
              ...
              <div class="conteudo">
                  ...
                  <div class="texto-acervo">
                      <p></p>
                      <p>Acesse o inteiro teor de livros, revistas, artigos de revista, trabalhos acadêmicos, produção intelectual de ministros, desembargadores e servidores da Justiça Eleitoral, entre outros documentos relativos a eleições, matéria
                          eleitoral e partidária e assuntos correlatos.
                      </p>
                  </div>
              </div>
              <div class="titulo-personalizado">
  ...
  <script>
      jq(document).ready(function() {
          jq('[data-load-remote]').on('click', function(e) {
              e.preventDefault();
              var $this = jq(this);
              var remote = $this.data('load-remote');
              if (remote) {
                  jq('#modal-noticias').modal('show').find('.modal-body').find('iframe').attr("src", remote);
              }
          });
      });
  </script>
