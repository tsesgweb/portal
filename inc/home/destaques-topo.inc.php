      ...
      <div class="noticia-secundaria">
        ...
        <div class="noticia-item noticia-item_video">
          ...
          <div class="noticia__titulo">
            ...
            <h3 class="titulo">
              <a href="http://localhost:3000/interna.php"
                >Biometria: identificação do eleitor pelas digitais garante mais
      ...
      <div class="card__linha">
        <div class="noticia__itens">
          <h3 class="noticia__titulo">
            <a href="#"
              >Processo Judicial Eletrônico será implantado nas zonas eleitorais
          ...
          <h3 class="noticia__titulo">
            <a href="#"
              >Decisões do Plenário destaca a cassação dos mandatos do prefeito
          ...
          <h3 class="noticia__titulo">
            <a href="#"
              >TSE cria Grupo de Trabalho para aprimorar aplicativo Pardal</a
            >
          </h3>
        </div>
          ...
          <button class="btn btn-custom">
            ...
            >
              ...
              <g transform="translate(-2.923 -111.1)">
                ...
                <path
                  class="a"
                  d="M365.153,839.813h-4.946a.207.207,0,1,1,0-.413h4.946a.207.207,0,1,1,0,.413Z"
                  transform="translate(-351.512 -715.319)"
                />
                <path
                  class="a"
                  d="M209.024,909.214H198.307a.207.207,0,1,1,0-.414h10.717a.207.207,0,1,1,0,.414Z"
                  transform="translate(-192.498 -783.482)"
                />
                <path
                  class="a"
                  d="M165.355,678.013h-1.649a.207.207,0,1,1,0-.413h1.649a.207.207,0,1,1,0,.413Z"
            ...
            >
              ...
              <g transform="translate(-46 -37)">
                <g transform="translate(36 27)">
                  ...
                  <path
                    class="a"
                    d="M40,57.333h3.667L41.833,50Z"
                    transform="translate(-24.5 -32.667)"
                  />
                </g>
              </g>
            </svg>
            ...
            >
              ...
              <g transform="translate(-122 -133)">
                <g transform="translate(122 133)">
                  ...
                  <path
                    class="a"
                    d="M34.259,30h-1.7v2.556H30v1.7h2.556v2.556h1.7V34.259h2.556v-1.7H34.259Z"
