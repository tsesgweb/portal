...
<div class="agenda-je ">
    ...
    <div class="agenda__linha">
        ...
        <!-- <div class="navega-evento row">
            <p>
                Pesquisar Eventos por:
            </p>
            <p>
                
                <button type="button" class="btn btn-primary" disabled title="Nenhum Evento na data">Atual</button>
                <button type="button" class="btn btn-success" title="Ver todos os Eventos">Todos</button>
                <button type="button" class="btn btn-secondary" title="Ver Eventos Anteriores">Anteriores</button>
                <button type="button" class="btn btn-warning" title="Ver Eventos Próximos">Próximos</button>
        ...
        <h2>Eventos - 13 de março de 2019</h2>
            ...
            <div id="accordion">
                    ...
                    <div class="panel panel-default materia">
                        <div class="panel-heading">
                            <h4 class="panel-title titulo-com">
                                <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">#1                                </a></h4>
                            ...
                            <div class="panel-body">
                                <div class="detalhes">
                                    ...
                                    <div class="crew__linha">Sr. Paulo Guedes - Ministro da Economia General
                                        ...
                                        Sr. Luís Felipe Salin Monteiro - Secretário de Governo Digital;</div>
                                    <h5><strong>Local:</strong></h5>
                                    <div class="place__linha"> STF, Salão Branco; </div>
                                    <div class="calendar__linha">
                ...
                <div class="panel-group">
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title titulo-com"> 
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapse4">Vivamus ligula nislasd faasdwe asdfa  qaera asdf asd asdfasdfasdfasdf easdaf asd qwerqwer </a></h4>
                    ...
                    <div id="collapse4" class="panel-collapse collapse">
                        ...
                        <div class="detalhes">
                            ...
                            ante vel sem eleifend, nec dictum orci porttitor. Nulla accumsan nec nisi aliquet viverra.</div>
                            <h5><strong>Local:</strong></h5>
                            <div class="place__linha"> STF, Salão Branco; </div>
                            <div class="calendar__linha">
